    ...
    return (
      <div className="App">
        <div className="sidebar">
          <div className="sidebar__show-hide">
            <img
              className="sidebar__show-hide__icon"
              src={leftIcon}
              alt=""
            ></img>
          </div>
          <div className="sidebar__container">
            ...
            <div className="sidebar__dropdown__featured">
              ...
              <ul
                className={this.state.isFeaturedShowing && "isFeaturedShowing"}
              >
            ...
            <div className="sidebar__dropdown__chicken">
              ...
              <ul className={this.state.isChickenShowing && "isChickenShowing"}>
                <li onClick={this.getWebhook} id={"getCowboyCaviar"}>
                  Cowboy Caviar
                </li>
            ...
            <div className="sidebar__dropdown__pork">
              ...
              <ul className={this.state.isPorkShowing && "isPorkShowing"}></ul>
            </div>
            {/*--------------Fish------------------------*/}
            <div className="sidebar__dropdown__fish">
              ...
              <ul className={this.state.isFishShowing && "isFishShowing"}></ul>
            </div>
            {/*--------------Veggies------------------------*/}
